...
# create Station object from bytele.game.bject that allows item to be contained in it
class Station(GameObject):
    """
    `Station Class Notes:`

        Station objects inherit from bytele.game.bject and can contain Item objects in them.
